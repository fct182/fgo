<template>
  <div>
    <el-table :data="paramsData" border>
      <el-table-column prop="id" label="规格参数ID" width="130"></el-table-column>
      <el-table-column prop="itemCatId" label="类目ID" width="130"></el-table-column>
...
export default {
  ...
  mounted() {
    this.$bus.$on("newParamsData", (result) => {
